    ...
    def validate(self, build: BuildManifest) -> list[BuildValidationIssue]:
        ...
        for emitted in build.files:
            ...
            if emitted.preserved:
                # Preserved user scripts are byte-for-byte inputs, not files
                # generated by RenWeave's deliberately small emitter grammar.
                # Their syntax is verified by the optional Ren'Py compile step.
                continue
            try:
